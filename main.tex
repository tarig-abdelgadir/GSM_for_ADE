...
% \begin{itemize}
%     \item $G \subset \SL(2,\bC)$ finite subgroup acting with no pseudo-reflections
%     \item $\rho_0, \ldots, \rho_N$
% irreducible representations of $G$ 
%     \item $\rho_0$ the trivial representation
%     \item $I=\{0,\ldots,N\}$
%     \item $W$ to be the direct sum of $\rho_i$'s that is isomorphic to defining representation
%     \item $X:=\Spec(S(W^\vee)^G) = W \GIT G$ singular affine quotient
%     \item $\bX:=W/G$ smooth stack quotient
%     \item $(Q,R)$ the McKay quiver with relations
%     \item $\cA:= \bk Q/ \langle R\rangle$ algebra associated to $(Q,R)$
%     \item $P_i:= \cA\bfe_i$ the projective module corresponding to the vertex $i$
%     \item $\bfd:=(\text{rank}(\rho_i))_{i \in I}$
%     \end{itemize}
% Fix a finite subgroup $G \subset \SL(2,\bC)$ and let $\rho_0, \ldots, \rho_N$ be its
% irreducible representations with $\rho_0$ being the trivial representation.
% Set $I=\{0,\ldots,N\}$.
...
\begin{gathered}
    ...
    %\ar[r]^-{\textup{id} \otimes \Omega} & V_i \otimes W^\vee \otimes L_W \ar[r]^-{\textup{id} \otimes \alpha_0^r} & 
    &&&& \bigwedge^r \Big(V_i \otimes W^\vee\Big).}
    \end{gathered}
\end{equation}
for $i\in I$ and $r=0,\ldots,d_i$.
% \begin{align}
%     \wedge^{d_i+r} B_i &= \alpha_0^r \alpha_i \circ \Omega_r(V_i \otimes W) \circ \wedge^{d_i-r} B^i \circ \Omega_r(\oplus V_j)^{-1}  \label{eq1:cons2} \\
%     \wedge^{d_i} B_i &= \alpha_i \circ \Omega_{0}(V_i \otimes W) \circ \wedge^{d_i} B^i \circ \Omega_{0}(\oplus V_j)^{-1} \label{eq2:cons2} \\
%     \alpha_0^r \alpha_i^{-1} \circ \wedge^{d_i-r} B_i &= \Omega_{-r}(V_i \otimes W) \circ \wedge^{d_i+r} B^i \circ \Omega_{-r}(\oplus V_j)^{-1} \label{eq3:cons2}
% \end{align}
\end{definition}
...
% \begin{equation}\label{eq:comdiag}
%     \xymatrix{V_i \otimes W \ar[r]^-{B_i} \ar[d]^{\textup{id}} & \big(\bigoplus_{i \rightarrow j}  V_j\big) \ar[r]^-{\Omega\,(B^i)^T \, \Omega} & V_i \otimes W^\vee \ar[d]^{\textup{id}} \\
%     V_i \otimes W \ar[r]^-{\textup{id} \otimes \Omega} & V_i \otimes W^\vee \otimes L_W \ar[r]^-{\textup{id} \otimes \alpha_0} & V_i \otimes W^\vee.}
% \end{equation}
% In particular, 
...
%     B_i^{-1} = \alpha_0^{-1} \circ \Omega_{d_i-1}(V_i \otimes W) \circ (B^i)^T \circ \Omega_{d_i-1}(\oplus V_j)^{-1}.
% \end{equation}
% \end{lemma}
